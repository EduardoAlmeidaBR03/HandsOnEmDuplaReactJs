...
const AdminCreateProductPage = () => {
  ...
  const fetchProductTypes = async () => {
    try {
      ...
      toast.error('Erro ao carregar tipos de produto', { icon: '❌' });
    }
  };
  ...
  const validateForm = () => {
    ...
    if (!product.product_type_id) {
      newErrors.product_type_id = 'Selecione o tipo de produto';
    }
    setErrors(newErrors);
    ...
    try {
        ...
        const payload = { 
            ...
            // Converter product_type_id para inteiro
            product_type_id: parseInt(product.product_type_id, 10)
        };
        ...
        console.log('product_type_id (como número):', payload.product_type_id, 'tipo:', typeof payload.product_type_id);
        ...
        toast.error(`Erro ao salvar: ${err.message || 'Erro desconhecido'}`, { icon: '❌' });
    }
    };
        ...
        <div className="card">
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                <label htmlFor="product_type_id" className="form-label">Tipo de Produto</label>
                <select
                  className={`form-select ${errors.product_type_id ? 'is-invalid' : ''}`}
                  id="product_type_id"
                ...
                {errors.product_type_id && <div className="invalid-feedback">{errors.product_type_id}</div>}
              </div>
